      ...
      <div className="container">
        <div className="register">
          <div className="register_left">
            <div className="register_tekst">
              ...
              <p className="registr2">
                {" "}
                <b>Tarjimon</b> yoki <b>Git</b> sifatida
              </p>
              <p className="registr3">ro'yxatdan o'ting</p>
            </div>
        ...
        <div className="takliflar">
          <div className="taklif_left">
            ...
            <div className="takliflarTekst">
              ...
              <p className="takliflar_tekst3">
                Siz o'zingizning profilingizni{" "}
              </p>
              <p className="takliflar_tekst3">
                to'ldirasiz va shaxsiy sahifangizni
              </p>
          ...
          <div className="taklif_orta">
            ...
            <div className="takliflarTekst">
              ...
              <p className="takliflar_tekst33">
                Siz shuningdek aktual so’rovlar ro'yxatini <br /> ko'rishingiz
                va sizga mos keladigan mijozlarga <br /> javob berishingiz
                mumkin.
              </p>
            </div>
          </div>
          <div className="taklif_right">
            ...
            <div className="takliflarTekst">
              ...
              <p className="takliflar_tekst33">
                Mijozlarga yaxshi xizmat ko’rsatgan xolda, ijobiy <br />{" "}
                fikirlar oling va rivojlaning.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="footerReg">
          <p className="footerRegText">
            Xoziroq ro’yhattan o’ting, ma’lumotlaringizni <br /> to’ldiring va
